...
CI_DECLARE_FUNC(void *) ci_cache_search(struct ci_cache_table *cache,void *key);
CI_DECLARE_FUNC(void *) ci_cache_update(struct ci_cache_table *cache, void *key, void *val);
